...
const FOCUS: Record<string, string> = {
  teknikal: `FOKUS: ANALISA TEKNIKAL murni. Bahas price action, EMA9/EMA21 & VWAP, RSI/MACD/Stochastic/Bollinger (%B & squeeze), ADX & arah tren (+DI/-DI), struktur pasar (HH/HL), konfluensi antar timeframe (M5/M15/H1), serta level major & level kunci lainnya. Simpulkan bias arah + zona entry, stop, dan target yang logis dari level yang ada. Abaikan makro kecuali relevan.`,
